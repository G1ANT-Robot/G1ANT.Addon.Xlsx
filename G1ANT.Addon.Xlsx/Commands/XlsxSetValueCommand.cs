...
namespace G1ANT.Addon.Xlsx
{
    ...
    public class XlsxSetValueCommand : Command
    {
        public  class Arguments : CommandArguments
        {
            ...
            public Structure Value { get; set; } = new TextStructure(string.Empty);
            ...
            [Argument(Tooltip = "Type of cell's data (Text, Number, Boolean, DateTime, TimeSpan)")]
        ...
        {                                                                           
            ...
            try
            {
                ...
                XlsxManager.CurrentXlsx.SetValue(arguments.Row.Value, col.ToString(), arguments.Value.Object, arguments.Type?.Value);
            ...
            catch (Exception ex)
            {
                ...
                throw new ApplicationException($"Problem occured while setting value. Row: '{arguments.Row.Value}', Col: '{col}', Val: '{arguments.Value.Object}'", ex);
            }
        }
    }
}
