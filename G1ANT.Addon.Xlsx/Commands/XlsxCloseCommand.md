...
| -------- | ---- | -------- | ------------- | ----------- |
|`id`| [integer](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/IntegerStructure.md) | no |  | ID of a file to close. If not set, the first opened file will be closed |
